...
def test_download_transcript_success(mocker):
    ...
    result = download_transcript(mock_url, LanguageCode('en'))
...
def test_download_transcript_as_srt_text_success(mocker):
    ...
    result = download_transcript_as_srt_text('https://youtube.com/watch?v=test', LanguageCode('en'))
    assert result == "1\n00:00:00,000 --> 00:00:02,000\nHello world\n\n2\n00:00:02,000 --> 00:00:04,000\nThis is a test\n\n"
...
def test_download_transcript_as_srt_file_success(mocker, tmp_path):
    ...
    result = download_transcript_as_srt_file('https://youtube.com/watch?v=test', LanguageCode('en'), output_path, OverwriteMode.ALWAYS)
...
def test_download_transcript_as_srt_file_exists_no_overwrite(mocker, tmp_path):
    ...
    result = download_transcript_as_srt_file('https://youtube.com/watch?v=test', LanguageCode('en'), output_path, OverwriteMode.NEVER)
    assert result is True
...
def test_download_transcript_as_srt_file_with_default_title_success(mocker, tmp_path):
    ...
    result = download_transcript_as_srt_file_with_default_title('https://youtube.com/watch?v=test', LanguageCode('en'), tmp_path, OverwriteMode.NEVER)
...
def test_download_transcript_as_srt_file_with_default_title_failure(mocker):
    ...
    mocker.patch.object(testee, 'download_transcript_as_srt_file', return_value=None)
    result = download_transcript_as_srt_file_with_default_title('https://youtube.com/watch?v=test', LanguageCode('en'), overwrite=OverwriteMode.NEVER)
    assert result is None
