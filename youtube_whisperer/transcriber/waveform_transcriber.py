...
from youtube_whisperer.utils import WhisperMode, verify_language_code


def transcribe_waveform(model: WhisperModel, waveform: np.ndarray, mode: WhisperMode, **kwargs) -> Iterable[Segment]:
    """
    ...
    Args:
        ...
        mode (WhisperMode): Whether to run Whisper in transcribe mode or translate mode.
...
def transcribe_waveform_with_default_model(waveform: np.ndarray, mode: WhisperMode, **kwargs) -> Iterable[Segment]:
    """
