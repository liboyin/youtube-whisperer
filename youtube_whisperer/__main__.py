...
def transcribe_to_srt_files(input_file_paths: Iterable[Path], language: LanguageCode, mode: TranscriberMode = TranscriberMode.TRANSCRIBE, overwrite: OverwriteMode = OverwriteMode.PROMPT) -> None:
    """
